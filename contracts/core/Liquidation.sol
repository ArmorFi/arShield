...
// We could change this to only find the value of the underlying rather than redeeming for underlying
// then all pools could essentially work the same (except for value discovery)
